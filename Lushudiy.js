...
(function() {
    ...
    baidu.object.extend(LuShu.prototype, {
        ...
        _addInfoWin: function() {
            ...
            //if(me._opts.defaultContent!== ""){
            if(me.overlay){
                this._map.removeOverlay(me.overlay);
            }
            me.overlay = new CustomOverlay(me._marker.getPosition(), me._opts.defaultContent);

            //将当前类的引用传给overlay。
            me.overlay.setRelatedClass(this);
            this._overlay = me.overlay;
            this._map.addOverlay(me.overlay);
        ...
        _move: function(initPos,targetPos,effect) {
            ...
            me._intervalFlag = setInterval(function() {
                ...
                if (currentCount >= count) {
                    ...
                    //画线
                    if(currentCount>1){
                        var pointsArr = [me.point1, pos]; //点数组
                        me._map.addOverlay(
        ...
        _moveNext: function(index) {
            ...
            if (index < this._path.length - 1) {
                var point1=new BMap.Point(me._path[index].x,me._path[index].y);
                var point2=new BMap.Point(me._path[index+1].x,me._path[index+1].y);
                me._opts.defaultContent="经度:"+me._path[index].x+"</br>"+
                    "纬度:"+me._path[index].y+"</br>"+
                    "站点："+me._path[index].name;
                me._addInfoWin();
                if(me._opts.defaultContent == ""){
                    me.hideInfoWindow();
                }
                me._move(point1, point2, me._tween.linear);
